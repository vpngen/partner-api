...
//go:generate swagger generate server --target ../../gen --name Admin --spec ../../swagger/swagger.yml --principal interface{} --exclude-main
...
func configureAPI(api *operations.AdminAPI) http.Handler {
	...
	if api.PostAdminHandler == nil {
		api.PostAdminHandler = operations.PostAdminHandlerFunc(func(params operations.PostAdminParams, principal interface{}) middleware.Responder {
			return middleware.NotImplemented("operation operations.PostAdmin has not yet been implemented")
		})
	}
	if api.PostLongpingHandler == nil {
